...
int main (int argc, char *argv[]) {
  ...
  // * var init
  // ? might need to move this block to lesser scope inside (file_size <= 4096)
  struct stat st;     // stat for measuring file size (from linux lib sys/stat.h)
  int file_size;      // size of current file (determines which algorithm)
